    ...
    <section class="breadcrumb__section section--padding">
        <div class="container">
            <div class="breadcrumb__content text-center" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
                <h1 class="breadcrumb__title h2"><span>Properties </span> Page</h1>
                <ul class="breadcrumb__menu d-flex justify-content-center">
                    ...
                    <li><span class="breadcrumb__menu--text">Properties Page </span></li>
                </ul>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row mb--n40">
                <?php foreach ($properties as $property): ?>
                    <?php if ($property['category'] === 'Buildings' || $property['category'] === 'Cars'): ?>
                        <div class="col-lg-6 col-md-6 mb-40" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="50">
                            <div class="project__items">
                                <div class="project__thumbnail big-screen">
                                    <a class="project__thumbnail--link w-100" href="listing-details.php?id=<?php echo $property['id']?> " >
                                        <img class="project__thumbnail--media img-fluid" src="functions/<?php echo $property['image']?>" alt="project-img" style="width: 100%; ">
                                    </a>
                                </div>
                                <div class="project__content">
                                    <span class="project__content--meta__tag"><?php echo $property['category'] ?></span>
                                    <h3 class="project__content--title"><a href="listing-details.php?id=<?php echo $property['id']?>"><?php echo $property['name'] ?></a></h3>
                                    <a class="project__content--link" href="listing-details.php?id=<?php echo $property['id'] ?>">View Details <svg width="17" height="7" viewBox="0 0 17 7" fill="none" xmlns="http://www.w3.org/2000/svg">
