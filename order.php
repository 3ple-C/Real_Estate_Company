    ...
    <section class="breadcrumb__section section--padding">
        <div class="container">
            <div class="breadcrumb__content text-center" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
                <h1 class="breadcrumb__title h2"><span>Building</span> Materials</h1>
                <ul class="breadcrumb__menu d-flex justify-content-center">
                    ...
                    <li><span class="breadcrumb__menu--text">Place Order</span></li>
                </ul>
            </div>
        </div>
    </section>
                        ...
                        <div class="contact__us--info__list d-flex align-items-center">
                            ...
                            <div class="contact__us--info__content">
                                ...
                                <p class="contact__us--info__text">
                                    <a href="mailto:info@example.com">info@royalhavenhomes.com</a> <br>
                                    <a href="tel:+23407030357998">+234-703-035-7998</a>
                                </p>
                            </div>
                        </div>
                        <div class="contact__us--info__list d-flex align-items-center">
                            ...
                            <div class="contact__us--info__content">
                                ...
                                <p class="contact__us--info__text desc">
                                    Suite c5,Freedom plaza, Amaku Hospital road, Aroma, Awka, Anambra state
                                </p>
                            </div>
                        </div>
                        <div class="contact__us--info__list d-flex align-items-center">
                            ...
                            <div class="contact__us--info__content">
                                ...
                                <p class="contact__us--info__text">
                                    <a href="tel:+2347030357998">+234 703 035 7998</a> <br>
                                    <a href="tel:+2348164441825">+234 816 444 1825</a>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="contact__us--map" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="150">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d26681.610107777993!2d7.061576350113711!3d6.2313887194843804!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1043830053c9ed5b%3A0xd88a287c3dc9b6dd!2sAroma!5e0!3m2!1sen!2snl!4v1727799581698!5m2!1sen!2snl" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div> -->
                        ...
                        <div class="row mb--n30">
                            <div class="col-lg-12 col-md-12 mb-30">
                                <div class="contact__form--input position-relative">
                                    <input class="contact__form--input__field" placeholder="Enter Your Name*" type="text" required>
                            ...
                            <div class="col-lg-12 col-md-12 mb-30">
                                <div class="contact__form--input position-relative">
                                    <input class="contact__form--input__field" placeholder="Enter Email Address*" type="email" required>
                            ...
                            <div class="col-lg-12 col-md-12 mb-30">
                                <div class="contact__form--input select">
                                    <select class="contact__form--select">
                                        ...
                                        <option value="4">Blocks</option>
                                        <option value="5">Woods
                                        </option>
                                        <option value="6">Plumbering materials</option>
                                        <option value="7">Sand, stones and gravel</option>
                                        <option value="8">Wiring</option>
                                        <option value="7">Circuit breakers,switches and outlets.</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="text-center">
                            <button class="contact__form--btn solid__btn px-5 mt-5">Send Order</button>
                        </div>
                    </form>
                </div>
            </div>
