                                    ...
                                    <?php foreach ($properties as $property): ?>
                                        <?php if ($property['category'] === 'Cars'): ?>
                                            <tr>
                                                <td>
                                                    <div class="properties__author d-flex align-items-center">
                                                        ...
                                                        <div class="reviews__author--text">
                                                            ...
                                                            <p class="reviews__author--subtitle"><?php echo $property['brand'] ?></p>
                                                ...
                                                <td>
                                                    <span class="status__btn text-center active"><?php echo $property['category'] ?></< /span>
                                                </td>
                                                <td>
                                                    <span class="properties__views text-center"><?php echo $property['color'] ?></span>
                                                </td>
                                                <td>
                                                    <span class="properties__views text-center"><?php echo $property['brand'] ?></span>
                                                </td>
                                                <td>
                                                    <span class="properties__views text-center"><?php echo $property['drive'] ?></span>
                                                </td>
                                                <td>
