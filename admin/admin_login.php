...
<head>
    ...
    <!-- Plugin css -->
    <link rel="stylesheet" href=".ssets/css/plugins/swiper-bundle.min.css">
            ...
            <div class="container-fluid">
                <div class="main__header d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__header--right d-flex align-items-center">
                        ...
                        <a class="add__listing--btn solid__btn" href="admin/create-listing.php"><span>Rgister</span> <svg width="18" height="18" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
