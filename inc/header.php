...
<body>
                ...
                <div class="main__header d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__header--right d-flex align-items-center">
                        <?php if (isset($_SESSION['user_name'])) {
                            ...
                            echo '<a class="login__register--link" href="login.php">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users">
                                <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
                                <circle cx="9" cy="7" r="4"></circle>
                                <path d="M23 21v-2a4 4 0 0 0-3-3.87"></path>
                                <path d="M16 3.13a4 4 0 0 1 0 7.75"></path>
                            </svg> <span>' . $username . '</span></a>';

                            echo '<a class="add__listing--btn solid__btn" href="functions/logout.php"><span>Logout</span></a>';
                        } else {
                            echo '<a class="login__register--link" href="login.php">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users">
                                <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
                            ...
                            echo '<a class="add__listing--btn solid__btn" href="sign-up.php"><span>Sign up</span> <svg width="18" height="18" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="offcanvas side__menu offcanvas-start" tabindex="-1" id="offcanvasExample">
        <div class="side__menu--header d-flex align-items-center justify-content-between">
            <h2 class="side__menu--title">Welcome to Royal Haven Homes</h2>
        ...
        <div class="side__menu--body">
            <nav class="offcanvas__menu ">
                <ul class="offcanvas__menu_ul">
                    <li class="offcanvas__menu_li pt-5">
            ...
            <div class="side__menu--footer">
                <div class="side__menu--info flex-column">
